...
const register = async (req, res) => {
  try {
    ...
    if (emailExist) throw { code: 409, message: "EMAIL_IS_EXIST" };

    if (String(req.body.password) !== String(req.body.retype_password)) throw { code: 428, message: "PASSWORD_NOT_MATCH" };
    ...
    if (!resultUser) throw { code: 500, message: "USER_REGISTER_FAILED" };
